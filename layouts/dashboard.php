...
<head>
	...
	<title>Administasi | Rumah Sakit</title>
...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/umah.png" class="brand">
			...
			<ul>
				...
				<li>
					<a href="<?php echo URL; ?>/pelanggan">
						<img class="icon" src="<?php echo AST; ?>/img/pasien.png" alt=""> Pasien
					</a>
				</li>
				<li>
					<a href="<?php echo URL; ?>/users">
						<img class="icon" src="<?php echo AST; ?>/img/usersus.png" alt=""> Users
					</a>
				</li>
				<li>
	...
	<main>
		...
		<footer>
			Copyright &copy; 2023. Designed by Irami
		</footer>
	</main>
